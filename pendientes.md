...
1. **Módulo de Mantenimiento Preventivo Planificado**: Generar alertas visuales (badges de colores) en el árbol de máquinas en base a ciclos de vida sugeridos para los repuestos asociados, indicando qué partes del sistema necesitan recambio inminente.
